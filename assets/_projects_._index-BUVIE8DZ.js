...
`}].map((e,t)=>i(h,{align:`start`,className:`rx-Stack`,css:{padding:`5px`,backgroundColor:`#f8f9fa`,border:`1px solid #dee2e6`,borderRadius:`12px`,boxShadow:`0 4px 6px rgba(0, 0, 0, 0.1)`,marginBottom:`16px`},direction:`column`,key:t,gap:`2`},i(_,{as:`p`,css:{fontSize:`0.9em`,color:`#6c757d`,marginBottom:`4px`}},e.date),i(v,{css:{fontSize:`1.2em`,fontWeight:`bold`,color:`#343a40`,marginBottom:`6px`}},e.title),i(D,{components:A(),css:{fontSize:`1em`,color:`#495057`},rehypePlugins:[C,S],remarkPlugins:[E,T,w]},e.description),i(u,{},i(c,{},i(m,{},`View More`)),i(l,{},i(s,{},e.title),i(D,{components:M(),css:{marginBottom:`10px`},rehypePlugins:[C,S],remarkPlugins:[E,T,w]},e.description),i(o,{},i(m,{size:`2`},`Close`)))))))}var P=t(function(){return i(k.Fragment,{},i(j,{}),i(`title`,{},`Projects`),i(`meta`,{content:`favicon.ico`,property:`og:image`}))});export{P as default};