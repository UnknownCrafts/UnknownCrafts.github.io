import{r as e}from"./rolldown-runtime-B5k6jGiM.js";import{A as t,j as n}from"./chunk-UIGDSWPH-Dav_R-61.js";import"./react-dom-CbM4KT_B.js";import{_ as r,a as i,c as a,d as o,f as s,g as c,i as l,l as u,n as d,o as f,p,r as m,s as h,u as g,v as _}from"./esm-qwCkVBuw.js";import"./reflex-env-Cip_wXPQ.js";import{n as v}from"./emotion-react.browser.esm-C_G51rFf.js";import{a as y,c as b,i as x,l as S,n as C,o as w,r as T,s as E,t as D,u as O}from"./one-dark-B-2hsOHS.js";import"./comma-separated-tokens-GyL9KmGA.js";var k=e(n());function A(){let{resolvedColorMode:e}=(0,k.useContext)(_);return{h1:({node:e,children:t,...n})=>v(r,{as:`h1`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`6`,...n},t),h2:({node:e,children:t,...n})=>v(r,{as:`h2`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`5`,...n},t),h3:({node:e,children:t,...n})=>v(r,{as:`h3`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`4`,...n},t),h4:({node:e,children:t,...n})=>v(r,{as:`h4`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`3`,...n},t),h5:({node:e,children:t,...n})=>v(r,{as:`h5`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`2`,...n},t),h6:({node:e,children:t,...n})=>v(r,{as:`h6`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`1`,...n},t),p:({node:e,children:t,...n})=>v(c,{as:`p`,css:{marginTop:`1em`,marginBottom:`1em`},...n},t),ul:({node:e,children:t,...n})=>v(`ul`,{css:{listStyleType:`disc`,marginTop:`1em`,marginBottom:`1em`,marginLeft:`1.5rem`,direction:`column`}},t),ol:({node:e,children:t,...n})=>v(`ol`,{css:{listStyleType:`decimal`,marginTop:`1em`,marginBottom:`1em`,marginLeft:`1.5rem`,direction:`column`}},t),li:({node:e,children:t,...n})=>v(`li`,{css:{marginTop:`0.5em`,marginBottom:`0.5em`}},t),a:({node:e,children:t,...n})=>v(d,{css:{"&:hover":{color:`var(--accent-8)`}},href:`#`,target:`_blank`,...n},t),code:({node:t,inline:n,className:r,children:i,...a})=>{let o=(r||``).match(/language-(?<lang>.*)/),s=o?o[1]:``;return n?v(u,{...a},i):v(T,{children:Array.isArray(i)?i.join(`
`):i,css:{marginTop:`1em`,marginBottom:`1em`},language:s,style:e?.valueOf?.()===`light`?.valueOf?.()?C:D,wrapLongLines:!0,...a})}}}function j(){let{resolvedColorMode:e}=(0,k.useContext)(_);return{h1:({node:e,children:t,...n})=>v(r,{as:`h1`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`6`,...n},t),h2:({node:e,children:t,...n})=>v(r,{as:`h2`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`5`,...n},t),h3:({node:e,children:t,...n})=>v(r,{as:`h3`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`4`,...n},t),h4:({node:e,children:t,...n})=>v(r,{as:`h4`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`3`,...n},t),h5:({node:e,children:t,...n})=>v(r,{as:`h5`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`2`,...n},t),h6:({node:e,children:t,...n})=>v(r,{as:`h6`,css:{marginTop:`0.5em`,marginBottom:`0.5em`},size:`1`,...n},t),p:({node:e,children:t,...n})=>v(c,{as:`p`,css:{marginTop:`1em`,marginBottom:`1em`},...n},t),ul:({node:e,children:t,...n})=>v(`ul`,{css:{listStyleType:`disc`,marginTop:`1em`,marginBottom:`1em`,marginLeft:`1.5rem`,direction:`column`}},t),ol:({node:e,children:t,...n})=>v(`ol`,{css:{listStyleType:`decimal`,marginTop:`1em`,marginBottom:`1em`,marginLeft:`1.5rem`,direction:`column`}},t),li:({node:e,children:t,...n})=>v(`li`,{css:{marginTop:`0.5em`,marginBottom:`0.5em`}},t),a:({node:e,children:t,...n})=>v(d,{css:{"&:hover":{color:`var(--accent-8)`}},href:`#`,...n},t),code:({node:t,inline:n,className:r,children:i,...a})=>{let o=(r||``).match(/language-(?<lang>.*)/),s=o?o[1]:``;return n?v(u,{...a},i):v(T,{children:Array.isArray(i)?i.join(`
`):i,css:{marginTop:`1em`,marginBottom:`1em`},language:s,style:e?.valueOf?.()===`light`?.valueOf?.()?C:D,wrapLongLines:!0,...a})}}}function M(){return v(g,{css:{spacing:`8`,width:`100%`,padding:`4`}},v(r,{css:{marginBottom:`10px`}},`My Projects Timeline`),v(O,{}),Array.prototype.map.call([{date:`2025`,title:`Real-Time Route Optimization System (🥇 1st Place, Programming Competition)`,description:`Developed a competition-winning route optimization system that solves the Vehicle Routing Problem with Time Windows (VRPTW) under strict performance constraints, achieving 1st place in a performance-based programming challenge.
...
`},{date:`Oct 2025`,title:`Quotify - Quantum Music Generator (🥉 3rd Place, IBM Qiskit Fall Fest 2025)`,description:`
...
`},{date:`2025`,title:`uOCTF`,description:`Our team achieved **1st place** 🥇 in the uOCTF 2025 Capture the Flag (CTF) competition, organized by the uOttawa Cybersecurity Club. This intense 3-hour event presented 30 challenges spanning Web Exploitation, Forensics, Hardware Security, and Cryptography.
...
`},{date:`2025`,title:`QNX FIGHTER (cuHacking 6)`,description:`* Ported a fighting game to multiple platforms:
...
Project available here: [https://devpost.com/software/qnx-fighter](https://devpost.com/software/qnx-fighter)`},{date:`2025`,title:`Sweatris (uOttaHack 7)`,description:`Sweatris: A Fitness-Themed Interactive Tetris Game
...
Side Note: The naive highschooler would have been proud to know that the live demo did not fail.`},{date:`2024-Present`,title:`Data Science Sounds Fun`,description:`Alright, winter break! Time to turn boredom into learning. Here's what I did:
...
* **R Implementation:**
    * Replicated the above data analysis using R and its respective libraries.`},{date:`2024`,title:`A Basic Computer`,description:`* Used an FPGA for this project.
...
* Developed a controller for the basic computer:
    ...
    * Control register ensures synchronous output using positive edge-triggered D-FF (flip-flops) connected to a common clock.`},{date:`2024`,title:`Rentify`,description:`* The goal of the app is to connect people who want to rent out their belongings with people who are looking to rent. The app supports item listing, searching, and renting, creating an easy-to-use service for both parties.
...
* Also did QA (Quality assurance) testing of the app to ensure high quality of the code.`},{date:`2024`,title:`MindScribeAI (Hack the Hill II)`,description:`* Developed an AI-powered journaling app using Flask (backend) and React (frontend).
...
`},{date:`2024`,title:`Regent`,description:`Apple shortcuts that help to extend Monarch Launcher's functionality.
...
`},{date:`2024`,title:`DockDoor`,description:`Contributed to an open source project called DockDoor.
...
`},{date:`2024`,title:`Python Projects`,description:`Gotta have that Pythonic journey to start!
...
`},{date:`2024`,title:`NoPDFPass`,description:`A simple app to remove the password restriction from PDFs.
...
`},{date:`2023`,title:`Object Detection With Raspberry PI `,description:`* Used publicly available TensorFlow models to perform object detection.
...
`},{date:`2023`,title:`RustyOS`,description:`A naive high schooler wants to make his own operating system. How bad can it be?
...
* Enabled the OS to boot onto bare metal.`},{date:`2022`,title:`Porting Minecraft Mods`,description:`Small minecraft programming arc, I mean that was the whole reason I got allowance to buy Minecraft Java edition anyways. (I totally wouldn't have it for any other reason)
...
`},{date:`2022`,title:`Smart Dustbin Project`,description:`A naive highschooler learned a painful truth: even after *intensive* testing, live demos are destined to fail.
...
`},{date:`2022`,title:`Traffic Lights Project`,description:`A naive highschooler learned a valuable lesson: projects *always* fail during live demos.
...
`},{date:`2022`,title:`BetterMacMod`,description:`This was a personal project where I wanted to make a rainmeter like app for MacOS using Python.
...
`},{date:`2021`,title:`Project Equinox (WolfHacks21)`,description:`Introducing to the residents of earth the first ever self sustaining habitable building that will make colonization on Plant Howler possible.
...
`},{date:`2021`,title:`Carelton Design Studio Projects`,description:`A naive highschooler wants to become a gamedeveloper because gaming is fun!
...
`},{date:`2020`,title:`Lonely Survivor (Weekly Game Jam - Week 149)`,description:`My first ever gamejam!
...
`},{date:`2017`,title:`The uh bricking incident`,description:`I bricked my mom's HTC M8 by trying to update SU using busybox. (So I guess technically it wasn't my fault)
...
* Sorry mom.
`},{date:`2017`,title:`Marble Rolling game`,description:`This was my first ever Unity project.
...
`}],(e,t)=>v(s,{align:`start`,className:`rx-Stack`,css:{padding:`5px`,backgroundColor:`#f8f9fa`,border:`1px solid #dee2e6`,borderRadius:`12px`,boxShadow:`0 4px 6px rgba(0, 0, 0, 0.1)`,marginBottom:`16px`},direction:`column`,key:t,gap:`2`},v(c,{as:`p`,css:{fontSize:`0.9em`,color:`#6c757d`,marginBottom:`4px`}},e?.date),v(r,{css:{fontSize:`1.2em`,fontWeight:`bold`,color:`#343a40`,marginBottom:`6px`}},e?.title),v(S,{components:A(),css:{fontSize:`1em`,color:`#495057`},rehypePlugins:[y,x],remarkPlugins:[b,E,w]},e?.description),v(h,{},v(i,{},v(o,{},`View More`)),v(f,{},v(l,{},e?.title),v(S,{components:j(),css:{marginBottom:`10px`},rehypePlugins:[y,x],remarkPlugins:[b,E,w]},e?.description),v(m,{},v(o,{size:`2`},`Close`)))))))}function N(){return v(a,{className:`hero`,css:{backgroundColor:`black`,animation:`reveal 0.35s ease-out`,"@keyframes reveal":{"0%":{opacity:`0`},"100%":{opacity:`1`}},padding:`16px`},size:`3`},[v(p,{className:`cube`}),v(p,{className:`cube`}),v(p,{className:`cube`}),v(p,{className:`cube`}),v(p,{className:`cube`}),v(p,{className:`cube`})],v(M,{}))}var P=t(function(){return v(k.Fragment,{},v(N,{}),v(`title`,{},`Projects`),v(`meta`,{content:`favicon.ico`,property:`og:image`}))});export{P as default};